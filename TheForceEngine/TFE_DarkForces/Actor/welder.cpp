...
namespace TFE_DarkForces
{
	...
	struct WelderShared
	{
		SoundSourceId weld2SoundSrcId;
		SoundSourceId weld1SoundSrcId;
		SoundSourceId weldSparkSoundSrcId;
		SoundSourceId weldHurtSoundSrcId;
		SoundSourceId weldDieSoundSrcId;
		s32 welderNum;
	};
	...
	Logic* welder_setup(SecObject* obj, LogicSetupFunc* setupFunc)
	{
		...
		memset(&physicsActor->moveMod.delta, 0, sizeof(physicsActor->moveMod.delta));
