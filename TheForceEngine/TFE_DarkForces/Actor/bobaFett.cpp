...
namespace TFE_DarkForces
{
	...
	enum AttackPhase TFE_ENUM_BASE(u32)
	{
		ATTACK_POINT     = 0,
		ATTACK_CIRCLE    = 1,
		ATTACK_FIGURE8   = 2,
	...
	enum SearchPhase TFE_ENUM_BASE(u32)
	{
		SEARCH_FIND = 0,
		SEARCH_RAND,
		SEARCH_CONTINUE
	...
	{
		SoundSourceId boba1SndID;
		SoundSourceId boba3SndID;
		SoundSourceId boba2SndID;
		SoundSourceId boba4SndID;
		SoundSourceId bobaRocket2SndID;
		s32 bobaFettNum;
	};
	...
	void bobaFett_serialize(Logic*& logic, SecObject* obj, Stream* stream)
	{
		...
		SERIALIZE_ZERO(SaveVersionInit, bobaFett->moveState.target);
