...
namespace TFE_DarkForces
{
	...
	void actorDispatch_serialize(Logic*& logic, SecObject* obj, Stream* stream)
	{
		...
		SERIALIZE_ZERO(SaveVersionInit, dispatch->vel);
		SERIALIZE_ZERO(SaveVersionInit, dispatch->lastPlayerPos);
	...
	void actor_serializeCollisionInfo(Stream* stream, CollisionInfo* colInfo)
	{
		...
		SERIALIZE_ZERO(SaveVersionInit, colInfo->responseDir);
		SERIALIZE_ZERO(SaveVersionInit, colInfo->responsePos);
	...
	{
		SERIALIZE_ZERO(SaveVersionInit, target->pos);
	...
	void actor_serializeMovementModuleBase(Stream* stream, MovementModule* moveMod)
	{
		...
		SERIALIZE_ZERO(SaveVersionInit, moveMod->delta);
	...
	void actor_serializeAttackModuleBase(Stream* stream, AttackModule* attackMod, ActorDispatch* dispatch)
	{
		...
		SERIALIZE_ZERO(SaveVersionInit, attackMod->fireOffset);
