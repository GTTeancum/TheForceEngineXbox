...
namespace TFE_DarkForces
{
	...
	void weaponFire_fist(MessageType msg)
	{
		...
		{
			ProjectileLogic* proj = (ProjectileLogic*)createProjectile(PROJ_PUNCH, s_playerObject->sector, s_playerObject->posWS.x, s_playerObject->posWS.y - s_playerObject->worldHeight + s_headwaveVerticalOffset, s_playerObject->posWS.z, s_playerObject);
	...
	void weaponFire_mine(MessageType msg)
	{
		...
		if (*s_curPlayerWeapon->ammo)
		{
			*s_curPlayerWeapon->ammo = pickup_addToValue(
			...
			// Animate (going down)
			s_weaponAnimState.frame = 1;
			s_weaponAnimState.startOffsetX = 0; s_weaponAnimState.startOffsetY = 0;
			s_weaponAnimState.xSpeed = 0; s_weaponAnimState.ySpeed = 20;
			s_weaponAnimState.frameCount = 5; s_weaponAnimState.ticksPerFrame = 7;
			...
			mine->vel.x = 0; mine->vel.y = 0; mine->vel.z = 0;
			...
			s_weaponAnimState.frame = frame;
			s_weaponAnimState.startOffsetX = 0; s_weaponAnimState.startOffsetY = 100;
			s_weaponAnimState.xSpeed = 0; s_weaponAnimState.ySpeed = -20;
			s_weaponAnimState.frameCount = 5; s_weaponAnimState.ticksPerFrame = 7;
			task_localBlockEnd;
			task_callTaskFunc(weapon_animateOnOrOffscreen);
