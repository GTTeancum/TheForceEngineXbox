...
#else
	u32 systemTime;							// iMuse 60Hz timer clock
	ImWaveSpeed waveSpeed;					// 0 = 11KHz, 1 = 22KHz
	s32 waveMixCount;						// set 0 to 16 mixer channels
	u32 imuseIntUsecCount;					// iMuse interrupt freq
#endif
};
...
enum iMuseSoundType TFE_ENUM_BASE(u64)  // Force enum to unsigned (C++ 11)
{
	typeMidi = 1u,
	typeWave = 2u,
