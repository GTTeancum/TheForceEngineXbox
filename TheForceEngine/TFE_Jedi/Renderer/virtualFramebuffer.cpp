...
namespace TFE_Jedi
{
	...
	JBool vfb_setResolution(u32 width, u32 height)
	{
		...
		s_screenRect[VFB_RECT_UI].left = 0;
		s_screenRect[VFB_RECT_UI].top = 0;
		s_screenRect[VFB_RECT_UI].right = s32(s_width) - 1;
		s_screenRect[VFB_RECT_UI].bot = s32(s_height) - 1;

		s_screenRect[VFB_RECT_RENDER].left = 0;
		s_screenRect[VFB_RECT_RENDER].top = 1;
		s_screenRect[VFB_RECT_RENDER].right = s32(s_width) - 1;
		s_screenRect[VFB_RECT_RENDER].bot = s32(s_height) - 2;
