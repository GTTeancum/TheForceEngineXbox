...
#ifdef _XBOX
// SDL_image-based image loading not available on Xbox.
namespace TFE_Image
{
	void init() {}
	void shutdown() {}
	SDL_Surface* get(const char*) { return NULL; }
	SDL_Surface* loadFromMemory(const u8*, size_t) { return NULL; }
	void free(SDL_Surface*) {}
	void freeAll() {}
	void writeImage(const char*, u32, u32, u32*) {}
	size_t writeImageToMemory(u8*, u32, u32, u32, u32, const u32*) { return 0; }
	void readImageFromMemory(SDL_Surface**, size_t, const u32*) {}
}
#else
